...
export default function ConfirmDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
      <div className="bg-juju-bleu border border-juju-light-bordure dark:border-juju-bordure rounded-2xl p-6 max-w-sm w-full">
        ...
        <div className="flex gap-3 justify-end">
          <button
            onClick={onCancel}
            disabled={loading}
            className="px-4 py-2 text-sm border border-juju-light-bordure dark:border-juju-bordure text-juju-texte rounded-lg hover:bg-juju-light-card dark:bg-juju-bleu-clair transition-colors disabled:opacity-50"
          >
            {cancelText}
          </button>
          <button
