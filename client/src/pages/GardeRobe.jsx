    ...
    <div className="px-4 py-6 md:px-8 md:py-10 max-w-6xl mx-auto">
      <header className="flex items-center justify-between mb-6">
        <div>
          ...
          {!loading && !error && (
            <p className="text-sm text-juju-texte-mute mt-1">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="p-2.5 rounded-lg border border-juju-bordure hover:border-juju-dore hover:text-juju-dore transition-colors"
          >
            <Search size={18} />
          </button>
          <button
...
function ArticleCard({ article }) {
  ...
  return (
    ...
    >
      <div className="aspect-square bg-juju-bleu rounded-lg overflow-hidden border border-juju-bordure group-hover:border-juju-dore transition-colors">
        {article.image_url ? (
          <img
        ...
        <div
          className="w-full h-full flex items-center justify-center text-juju-texte-mute"
      ...
      <div className="mt-2 px-0.5">
        ...
        {subtitle && (
          <p className="text-xs text-juju-texte-mute mt-0.5 truncate">{subtitle}</p>
        )}
      </div>
    </Link>
  );
...
function EmptyState() {
  return (
    <div className="text-center py-20 max-w-sm mx-auto">
      <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-juju-bleu border border-juju-bordure flex items-center justify-center">
