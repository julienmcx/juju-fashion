  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 gap-4 mb-8 max-w-md mx-auto">
        <div>
          <p className="text-xs uppercase tracking-wider text-juju-texte-mute mb-2 text-center">
            Article
          </p>
          <div className="aspect-square bg-juju-bleu rounded-xl overflow-hidden border border-juju-bordure">
        ...
        <div>
          ...
          <div className="aspect-square bg-juju-bleu rounded-xl overflow-hidden border border-juju-bordure flex items-center justify-center">
            <Sparkles size={36} className="text-juju-dore" />
          </div>
          <p className="text-sm text-juju-texte-mute mt-2 text-center">4 angles · ~25 s</p>
        </div>
      </div>
      ...
      <div className="text-center">
        ...
        <p className="text-xs text-juju-texte-mute mt-3">
  ...
  return (
    <div className="text-center py-20">
      <div className="relative inline-block mb-6">
        <div className="w-20 h-20 rounded-full border-2 border-juju-bordure" />
      ...
      <p className="text-sm text-juju-texte-mute max-w-sm mx-auto">
...
function SuccessView({ tryonData, index, setIndex, onRetry }) {
  ...
  return (
    <div>
      ...
      {partialWarning && (
        <p className="text-xs text-juju-texte-mute mb-4 text-center">
    ...
    <div className="text-center py-16 max-w-md mx-auto">
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        ...
        <Link
          ...
          className="px-6 py-3 border border-juju-bordure text-juju-texte rounded-lg hover:bg-juju-bleu-clair transition-colors"
        >
          Retour au détail
        </Link>
      </div>
  ...
  return (
    <div className="px-4 py-6 md:px-8 md:py-10 max-w-2xl mx-auto">
      ...
      <div className="text-center py-16">
        ...
        <p className="text-sm text-juju-texte-mute mb-6 max-w-md mx-auto">{message}</p>
        {ctaLabel && ctaTo && (
          <Link
            to={ctaTo}
...
function CenteredMessage({ children, error }) {
  return (
    <div className={`px-4 py-20 text-center ${error ? 'text-red-400' : 'text-juju-texte-mute'}`}>
      {children}
    </div>
  );
}