...
export default function BottomTabBar() {
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-juju-bleu/95 backdrop-blur-md border-t border-juju-bordure z-10">
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `flex flex-col items-center gap-1 transition-colors ${
                  isActive ? 'text-juju-dore' : 'text-juju-texte-mute'
                }`
              }
            >
